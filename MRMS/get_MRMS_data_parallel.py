...
def construct_urls(base_url, date_range):
    return [f"{base_url}{date.strftime('%Y')}/{date.strftime('%m')}/{date.strftime('%d')}/mrms/ncep/MultiSensor_QPE_01H_Pass2/" for date in date_range]
...
if __name__ == '__main__':
    ...
    for year in years:
        ...
        download_dir = os.path.join(r"Y:\ATD\GIS\MRMS_Data\MRMS Data USA", str(year)) 
